...
- `stdlib/` - The standard library
  ...
  - `util/` - Utility stuff only used by the standard library
    ...
    - `gui_styles.css` - CSS styles for GUI on web
    - `gui_styles.hpp` - Those CSS styles in a raw string (generated by `build.caro`)
    - `raylib.hpp` - Loading raylib
    - `networking.hpp` - HTTP and WebSocket
    - `json_parser.hpp` - JSON parsing
