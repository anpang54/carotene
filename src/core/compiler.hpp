    ...
    public:
        ...
        void makeBinary(bool canAssign) {
            ...
            switch(operatorType) {
                ...
                case TOKEN_AND:                 emitByte(OP_BITWISE_AND);   break;
                case TOKEN_OR:                  emitByte(OP_BITWISE_OR);    break;
                case TOKEN_XOR:                 emitByte(OP_BITWISE_XOR);   break;
                case TOKEN_LESS_LESS:           emitByte(OP_LEFT_SHIFT);    break;
                case TOKEN_GREATER_GREATER:     emitByte(OP_RIGHT_SHIFT);   break;
        ...
        int compoundOperator(TokenType type) {
            switch(type) {
                ...
                case TOKEN_AND_EQUAL:             return OP_BITWISE_AND;
                case TOKEN_OR_EQUAL:              return OP_BITWISE_OR;
                case TOKEN_XOR_EQUAL:             return OP_BITWISE_XOR;
                case TOKEN_LESS_LESS_EQUAL:       return OP_LEFT_SHIFT;
                case TOKEN_GREATER_GREATER_EQUAL: return OP_RIGHT_SHIFT;
        ...
        void makeCoalesce(bool canAssign) {

            int endJump = emitJump(OP_JUMP_IF_NOT_NULL);

            emitByte(OP_POP);
            parsePrecedence(PREC_COALESCE);
...
//   token                        prefix                   infix                     precedence
    ...
    [TOKEN_LESS_LESS]             = { NULL,                    &Compiler::makeBinary,    PREC_SHIFT       },
    ...
    [TOKEN_GREATER_GREATER]       = { NULL,                    &Compiler::makeBinary,    PREC_SHIFT       },
